...
namespace EasyLoan.UnitTest.Services
{
    ...
    public class EmiCalculatorServiceTests
    {
        ...
        [TestMethod]
        public void GenerateSchedule_WhenValidInputs_ReturnsCorrectNumberOfEmis()
        {
            // Arrange
        ...
        [TestMethod]
        public void GenerateSchedule_WhenCalled_EmiAmountIsConstantAcrossSchedule()
        {
            // Arrange
            var schedule = _service.GenerateSchedule(
                principal: 200000,
        ...
        [TestMethod]
        public void GenerateSchedule_WhenTenureIsOne_ReturnsSingleEmi()
        {
            // Act
            var schedule = _service.GenerateSchedule(
                principal: 50000,
