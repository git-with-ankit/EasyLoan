...
namespace EasyLoan.DataAccess.Migrations
{
    ...
    [Migration("20260203061519_Added field for storing paid penalty")]
    partial class Addedfieldforstoringpaidpenalty
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("EasyLoan.DataAccess.Models.LoanDetails", b =>
                {
                    ...
                    b.HasOne("EasyLoan.DataAccess.Models.LoanApplication", "LoanApplication")
                        .WithOne("LoanDetails")
                        .HasForeignKey("EasyLoan.DataAccess.Models.LoanDetails", "LoanApplicationId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
