...
//        [ProducesResponseType(typeof(ApiResponseDto<object>), StatusCodes.Status403Forbidden)]
//        [ProducesResponseType(typeof(ApiResponseDto<object>), StatusCodes.Status422UnprocessableEntity)]
//        public async Task<ActionResult<ApiResponseDto<List<DueEmisResponseDto>>>> GetNextPaymentAsync(string loanNumber)
//        {
//            var customerId = User.GetUserId();
//            var payment = await _service.GetNextPaymentAsync(customerId, loanNumber);
//            return Ok(new ApiResponseDto<List<DueEmisResponseDto>> { Success = true, Data = payment });
//        }
